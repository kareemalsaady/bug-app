...
var BugDetailComponent = (function () {
    ...
    BugDetailComponent.prototype.configureForm = function (bug) {
        ...
        this.bugForm = this.formB.group({
            title: [this.currentBug.title, [forms_1.Validators.required, forbidden_string_validator_1.forbiddenStringValidator(/puppy/)]],
            status: [this.currentBug.status, forms_1.Validators.required],
            severity: [this.currentBug.severity, forms_1.Validators.required],
            description: [this.currentBug.description, [forms_1.Validators.required, forbidden_string_validator_1.forbiddenStringValidator(/abcd/i)]]
        });
    };
    ...
    BugDetailComponent.prototype.freshForm = function () {
        this.bugForm.reset({ status: this.statuses.Logged, severity: this.severiies.Severe });
        this.cleanBug();
    };
    BugDetailComponent.prototype.cleanBug = function () {
        this.currentBug = new bug_1.Bug(null, null, this.statuses.Logged, this.severiies.Severe, null, null, null, null, null);
    };
