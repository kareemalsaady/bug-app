...
export class BugDetailComponent implements OnInit {
    ...
    configureForm(bug?: Bug){
      ...
      this.bugForm = this.formB.group({
        title: [this.currentBug.title, [Validators.required, forbiddenStringValidator(/puppy/)]],
        status: [this.currentBug.status, Validators.required],
        severity: [this.currentBug.severity, Validators.required],
        description: [this.currentBug.description, [Validators.required, forbiddenStringValidator(/abcd/i)]]
      })
    }
    ...
    cleanBug() {
      this.currentBug = new Bug(null, null, this.statuses.Logged, this.severiies.Severe, null, null, null, null, null);
    }
 }
